        ...
        <>
            <Container fluid style={{ width: "82%" }}>
                <Col style={{ display: "flex", flexDirection: "row", alignItems: "center", justifyContent: "start" }}>
                    ...
                    <div style={{ height: "2vw", width: "40%", borderRadius: "0.5vw" }}><h5>{recipeDetail.step_name}</h5></div>
                </Col>
                <Col style={{ display: "flex", flexDirection: "row", alignItems: "center", justifyContent: "start" }}>
                    ...
                    <div style={{ height: "4vw", width: "100%", borderRadius: "0.5vw", paddingBottom: "0.4vw", paddingLeft: "0.3vw" }}>{recipeDetail.description}</div>
                </Col>
            </Container>
        </>
    );
