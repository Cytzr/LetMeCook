        ...
        <>
            <Container fluid style={{ width: "82%" }}>
                <Col style={{ display: "flex", flexDirection: "row", alignItems: "center", justifyContent: "start" }}>
                    ...
                    <input onChange={(e) => handleSetStepName(e)} value={recipeDetail.stepName} type="text" style={{ height: "2vw", width: "40%", borderRadius: "0.5vw", padding: "0.55vw", border: "solid grey 1px" }} />
                </Col>
                <Col style={{ display: "flex", flexDirection: "row", alignItems: "center", justifyContent: "start" }}>
                    ...
                    <textarea onChange={handleSetStepDescription} value={recipeDetail.stepDescription} style={{ height: "4vw", width: "100%", borderRadius: "0.5vw", padding: "0.4vw" }}></textarea>
                </Col>
            </Container>
        </>
    )
